h18972
s 00029/00004/00261
d D 6.3 03/11/18 22:18:18 msokolov 3 2
c update for 4.3BSD-Quasijarus
e
s 00000/00000/00265
d D 6.2 03/11/16 16:24:49 msokolov 2 1
c bump it up to 6.2
e
s 00265/00000/00000
d D 6.1 03/11/16 16:23:07 msokolov 1 0
...
E 3
I 3
This should not be necessary if using console media,
but has been included as a fallback
E 3
...
as they have no console media.
\fBWARNING\fP:  the bootstraps supplied below
E 3
...
I 3
The following description of toggle-in code applies only to large
VAXen with non-TMSCP tapes.
On MicroVAXen all you need to do is to boot from the distribution tape:
.DS
\fB>>>\fP\fIB MUA0\fP
.DE
and the ``='' prompt will appear.
On large VAXen a more complex procedure described below must be used instead.
Once again, it works only for non-TMSCP tapes.
To bootstrap \*(4B on a large VAX from a TMSCP tape drive you must use console
media.
This procedure can be used on an 8200, however, since 8200s normally use TMSCP
tapes it is unlikely to be very useful.
E 3
Temporarily
