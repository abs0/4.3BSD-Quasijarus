h21022
s 00850/00000/00000
d D 1.1 85/05/23 17:08:19 miriam 1 0
c date and time created 85/05/23 17:08:19 by miriam
e
u
U
t
...
#  sin/cos/tan  for the VAX using Bob Corbett's argument reduction.
#  
#  Notes:
#       under 1,024,000 random arguments testing on [0,2pi] 
#       tan() observed maximum error = 2.15 ulps
#       sin() observed maximum error = 0.814 ulps
#       cos() observed maximum error = 0.792 ulps
#  
#
# double {sin,cos,tan}(arg)
# double arg;
...
#  number in  r1/r0 .  The magnitiude of
...
#						p.8
#
#  Check for massivve cancellation.
#
...
#  genreate another  24  result bits.
...
#
	...
	beql	tiny
#
#  Find the postion of the first one bit in  r10 .
#
	cvtld	r10,r1
	extzv	$7,$7,r1,r1
#
...
tinier:
	beql	zero
#
#  FInd the postiion of the first one bit in  r9 .
#
	cvtld	r9,r1
	extzv	$7,$7,r1,r1
#
...
#  result for the unlikeley possibility that
