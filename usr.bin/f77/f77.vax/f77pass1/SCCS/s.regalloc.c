h55741
s 00007/00007/02283
d D 5.6 88/01/03 15:57:38 bostic 6 5
c const is an ANSI C keyword
e
s 00067/00032/02223
d D 5.5 86/04/27 00:03:24 donn 5 4
c Still more hacking with GOTOs and loops!  What a mess.  This time we
c complete the illusion that adjacent loops are actually embedded loops.
c Without this hack, variables which are in one loop but not in another
c adjacent loop cause severe confusion.  A routine varloopset() is added
c to re-implement the loopset hack; I'm not certain that this is really
c needed at all, now.
e
s 00063/00010/02192
d D 5.4 86/01/07 21:07:33 donn 4 3
c (1) Fix bugs with GOTOs from an inner loop into an outer loop.
c (2) Pick up redundant register moves when address registers (STGPREG) are
c involved.
e
s 00012/00001/02190
d D 5.3 85/10/06 19:41:50 donn 3 2
c Added a fix for a bug that allowed character variables which were
c arguments to subroutines to be made eligible to be register variables.
e
s 00007/00000/02184
d D 5.2 85/09/28 11:49:08 bloom 2 1
c fix problem of trying to put a short into a register from (donn@utah-cs)
e
s 02184/00000/00000
d D 5.1 85/06/07 21:46:27 mckusick 1 0
