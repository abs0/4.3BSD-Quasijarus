h14464
s 00004/00004/00577
d D 5.2 05/01/12 07:31:15 msokolov 2 1
c EPS implemented
e
s 00581/00000/00000
d D 5.1 05/01/11 05:58:58 msokolov 1 0
c date and time created 05/01/11 05:58:58 by msokolov
e
u
U
t
...
static	int	aflg, dflg, sflg, tflg, uflg, iflg, fflg;
static	int	cflg, rflg = 1;
static	int	qflg, Aflg = 1, Cflg, Fflg, Lflg, Rflg;

static	time_t	now, sixmonthsago;

static	char	*dotp = ".";

static	int	twidth = 80, usetabs = 0;
...
D 2
	    p->fnl, uname, longlist ? gname : "", fsize, ftime);
E 2
I 2
	    p->fnl, uname, !chrooted ? gname : "", fsize, ftime);
E 2
	return (lstuffbuf);
}
