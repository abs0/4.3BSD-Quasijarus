h15091
s 00080/00000/00714
d D 5.7 10/09/13 00:17:53 msokolov 7 6
c B-spline conversion implemented like in the original psdit
e
s 00022/00002/00692
d D 5.6 10/09/07 07:20:01 msokolov 6 5
c the arc code should now be final!
e
s 00007/00008/00687
d D 5.5 10/09/07 07:08:34 msokolov 5 4
c generic arc code now works for both CW and CCW directions
e
s 00086/00017/00609
d D 5.4 10/09/07 07:00:04 msokolov 4 3
c non-quadrant elliptic arcs should be correct now too
c CW arcs still aren't right though
e
s 00145/00032/00481
d D 5.3 10/09/06 22:28:27 msokolov 3 2
c it looks like we've finally got elliptic arcs right
e
s 00001/00000/00512
d D 5.2 10/08/29 04:46:16 msokolov 2 1
c silly \D'e...' parsing bug
e
s 00512/00000/00000
d D 5.1 10/08/29 03:25:09 msokolov 1 0
c date and time created 10/08/29 03:25:09 by msokolov
e
u
U
t
...
D 3
	if (dh > 0 && dv > 0 || dh < 0 && dv < 0)
		...
		signfactor = -1;
	xd = dv * quadarc_convfactor * signfactor;
	yd = dh * quadarc_convfactor * signfactor;
E 3
I 3
...
I 3
D 4
	if (is_arc_elliptic(dh1, dv1, dh2, dv2, &a, &b)) {
		aoverb = a / b;
		bovera = b / a;
	} else
		aoverb = bovera = 1.0;
	x1 = -dv1 * controldelt * aoverb;
	y1 = dh1 * controldelt * bovera;
E 4
I 4
D 5
	x1 = -dv1 * controldelt * ellarc_aoverb;
	y1 = dh1 * controldelt * ellarc_bovera;
E 5
I 5
...
I 3
D 4
	x2 = x3 - dv2 * controldelt * aoverb;
	y2 = y3 + dh2 * controldelt * bovera;
E 4
I 4
D 5
	x2 = x3 - dv2 * controldelt * ellarc_aoverb;
	y2 = y3 + dh2 * controldelt * ellarc_bovera;
E 5
I 5
...
I 3
D 6
	drawelement_genarc(dh1, dv1, midx, midy, cw);
	drawelement_genarc(-midx, -midy, dh2, dv2, cw);
E 6
I 6
