dnl	@(#)symbol.m4	2.2	(Berkeley)	2012/03/09
%!PS-Adobe-3.0 Resource-Font
%%BeginResource: font TroffEmu-Symbol
11 dict begin
/FontInfo 10 dict dup begin
/version (2.2 2012/03/09) readonly def
/Notice (Based on Adobe Symbol with 4.3BSD-Quasijarus troff modifications) readonly def
/FullName (Troff Emulation Symbol) readonly def
...
currentdict end
dup /Private 13 dict dup begin
/|-{readonly def}bind def
/|{readonly put}bind def
/BlueValues [ -17 0 673 685 487 500 ] |-
/MinFeature{16 16} |-
/StdHW [ 92 ] |-
/StdVW [ 95 ] |-
/ForceBold false def
/password 5839 def
/lenIV -1 def
syscmd(cat symbol.pscode)dnl
include(symbolsubrs.m4)dnl
2 `index' /CharStrings 191 dict dup begin
include(symbolchars.m4)dnl
include(bellsystem.m4)dnl
end
end
readonly put
readonly put
