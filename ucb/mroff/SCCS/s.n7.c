h22625
s 00002/00003/00760
d D 5.4 2012/03/04 02:06:19 msokolov 4 3
c tr handles the full 512-char set now
e
s 00001/00001/00762
d D 5.3 10/08/25 06:47:18 msokolov 3 2
c ancient bug: the old troff hyphen code was still there
e
s 00001/00001/00762
d D 5.2 04/09/11 08:36:47 msokolov 2 1
c use INT_MAX instead of 32767
c with smaller units the page length exceeds 32767 and was giving us trap botches
e
s 00763/00000/00000
...
gettch(){
	...
	if(!((i = getch()) & MOT) && (i & ulbit)){
		j = i&CMASK;
D 4
		if(cu && !(j & 0x100) && (trtab[j] == ' '))
E 4
I 4
		if(cu && (trtab[j] == ' '))
E 4
			i = ((i & ~ulbit)& ~CMASK) | '_';
		if(!cu && !(*t.codetab[j] & 0200))
			i &= ~ulbit;
	}
	return(i);
}
