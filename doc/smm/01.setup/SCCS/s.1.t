h41352
s 00001/00001/00406
d D 6.4 03/11/24 22:46:23 msokolov 4 3
c document support for RF35, RF36, and RF74
e
s 00046/00034/00361
d D 6.3 03/11/18 22:18:03 msokolov 3 2
c update for 4.3BSD-Quasijarus
e
s 00000/00000/00395
d D 6.2 03/11/16 16:24:46 msokolov 2 1
c bump it up to 6.2
e
s 00395/00000/00000
d D 6.1 03/11/16 16:23:05 msokolov 1 0
...
E 3
I 3
4.2BSD and 4.3BSD user filesystems may be upgraded in place,
E 3
...
i.e., KA630 for MicroVAX II, KA650 for MicroVAX 3, and KA655 for MicroVAX 3+.
E 3
.PP
...
E 3
I 3
VAX 8200, VAX-11/780, VAX-11/750, VAX-11/730, or MicroVAX II/3/3+
E 3
...
.DE
.FS
* Other compatible UNIBUS controllers and drives
...
D 3
RA?? includes the RA60, RA70, RA80, RA81, and RA82,
...
E 3
I 3
Known RA drives are RA60, RA7[0123], RA8[012], and RA9[02].
D 4
Known RF drives are RF3[01] and RF7[123].
E 4
I 4
Known RF drives are RF3[0156] and RF7[1234].
E 4
Other SMD and MSCP drives may be used once pack labels are written,
but bootstrapping will be a problem since the procedure currently
relies on compiled-in disk tables.
E 3
.FE
.PP
...
I 3
DEC BI:	TU81\(dg
DEC QBUS:	TK50, TK70, TU80, TU81\(dg
E 3
.TE
.DE
.FS
...
E 3
I 3
In addition, only 9-track (TU81) tapes are supported on VAXBI,
TK50 and TK70 are not.
BI Ethernet and terminal controllers are not supported either,
for this reason, although it can be bootstrapped, a VAX 8200 without a UNIBUS
...
E 3
I 3
The basic distribution is available in the following formats:
E 3
.DS
D 3
...
E 3
I 3
*\0\0 1600bpi 9-track 2400' magnetic tapes (2)
*\0\0 6250bpi 9-track 2400' magnetic tape (1)
*\0\0 TK50 tape cartridge (1)
E 3
.DE
I 3
...
that use them:
.DS
*\0\0 RX01 console floppy disk for 11/780
*\0\0 TU58 console cassette for 11/750 and 11/730
*\0\0 RX50 console floppy disk for 8200
*\0\0 RL02 console pack for 8600
.DE
E 3
...
E 3
I 3
are not suitable for use as operational console media
for 11/780, 11/730 and 8600 processors because they do not
contain CPU microcode or front end processor code.
Their intended use is only for installation.
E 3
.PP
...
the device on that adapter.  The drive number is
the index of the disk drive on that controller (or,
for MASSBUS tapes, of the formatter).  The \fIp\fP
...
D 3
Although the tape(s) contain only 7 tape files, they comprise
E 3
I 3
Although the tape(s) contain only 6 tape files, they comprise
E 3
...
Normally, the adapter and controller will both be 0; it
...
D 3
``special files'' normally live, the ``hp'' serves the obvious purpose,
E 3
I 3
``special files'' normally live, the ``ra'' serves the obvious purpose,
E 3
the ``2'' identifies this as a partition of hp drive number ``2''
...
I 3
Although DEC apparently doesn't want you to know this,
BI KLESI (TU81 controller) is actually a UNIBUS adapter with a UNIBUS KLESI
behind it.  Unlike DEC software
.UX
treats it as a regular UNIBUS adapter, and it must be taken into account
when counting UNIBUS adapters.
E 3
...
usage: it allows access to the entire physical device, in many
cases including bad
